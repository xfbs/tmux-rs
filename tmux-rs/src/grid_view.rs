...
fn grid_view_x(gd: *mut grid, x: u32) -> u32 { x }
unsafe fn grid_view_y(gd: *mut grid, y: u32) -> u32 { unsafe { (*gd).hsize + (y) } }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_clear(gd: *mut grid, mut px: u32, mut py: u32, nx: u32, ny: u32, bg: u32) {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_scroll_region_up(gd: *mut grid, mut rupper: u32, mut rlower: u32, bg: u32) {
    unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_scroll_region_down(gd: *mut grid, mut rupper: u32, mut rlower: u32, bg: u32) {
    unsafe {
        rupper = grid_view_y(gd, rupper);
        rlower = grid_view_y(gd, rlower);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_insert_lines_region(gd: *mut grid, mut rlower: u32, mut py: u32, ny: u32, bg: u32) {
    unsafe {
        rlower = grid_view_y(gd, rlower);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_delete_lines_region(gd: *mut grid, mut rlower: u32, mut py: u32, ny: u32, bg: u32) {
    unsafe {
        rlower = grid_view_y(gd, rlower);
...
/// Insert characters.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_insert_cells(gd: *mut grid, mut px: u32, mut py: u32, nx: u32, bg: u32) {
    unsafe {
        px = grid_view_x(gd, px);
        py = grid_view_y(gd, py);
...
/// Delete characters.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_delete_cells(gd: *mut grid, mut px: u32, mut py: u32, nx: u32, bg: u32) {
    unsafe {
        px = grid_view_x(gd, px);
        py = grid_view_y(gd, py);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn grid_view_string_cells(gd: *mut grid, mut px: u32, mut py: u32, nx: u32) -> *mut c_char {
    unsafe {
        px = grid_view_x(gd, px);
        py = grid_view_y(gd, py);

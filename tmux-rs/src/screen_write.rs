use compat_rs::{
    ...
    queue::{tailq_concat, tailq_empty, tailq_head_initializer, tailq_init, tailq_insert_tail, tailq_remove},
    tailq_insert_after, tailq_insert_before,
};
...
unsafe extern "C" {
    ...
    // pub fn screen_write_vnputs(_: *mut screen_write_ctx, _: isize, _: *const grid_cell, _: *const c_char, _: VaList);

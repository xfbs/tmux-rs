...
pub unsafe extern "C" fn vis(
    ...
    if (c == '\\' as i32 || flag & 0x400 as libc::c_int == 0 as libc::c_int)
        && (c as u_int <= (127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int) as libc::c_uint
    ...
    if flag & 0x2 as libc::c_int != 0 {
        match c {
            10 => {
                current_block = 6277534531462516928;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
                    ...
                    _ => {
                        ...
                        *fresh19 = '0' as i32 as libc::c_char;
                        if nextc as u_char as libc::c_int >= '0' as i32 && nextc as u_char as libc::c_int <= '7' as i32
                        {
                            let fresh20 = dst;
                            dst = dst.offset(1);
                ...
                current_block = 4486056587157377032;
            }
            13 => {
                current_block = 3174314384866971503;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            8 => {
                current_block = 853049728065795787;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            7 => {
                current_block = 4187689338455206605;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            11 => {
                current_block = 3340818859333384547;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            9 => {
                current_block = 13036738301493287333;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            12 => {
                current_block = 13399456980345436462;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            32 => {
                current_block = 8888485832859197424;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
            ...
            0 => {
                current_block = 11567789488641827265;
                match current_block {
                    6277534531462516928 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
        ...
        15345278821338558188 => {
                    ...
                    && (c == '*' as i32 || c == '?' as i32 || c == '[' as i32 || c == '#' as i32)
            {
                ...
                *fresh22 = '\\' as i32 as libc::c_char;
                let fresh23 = dst;
                dst = dst.offset(1);
                *fresh23 = ((c as u_char as libc::c_int >> 6 as libc::c_int & 0o7 as libc::c_int) + '0' as i32)
                    as libc::c_char;
                let fresh24 = dst;
                dst = dst.offset(1);
                *fresh24 = ((c as u_char as libc::c_int >> 3 as libc::c_int & 0o7 as libc::c_int) + '0' as i32)
                    as libc::c_char;
                let fresh25 = dst;
                dst = dst.offset(1);
                *fresh25 = ((c as u_char as libc::c_int & 0o7 as libc::c_int) + '0' as i32) as libc::c_char;
            } else {
...
pub unsafe extern "C" fn strnvis(
    ...
    loop {
                            ...
                            != 0))
        {
            ...
            *fresh34 = c as libc::c_char;
            ...
            src = src.offset(1);
            i = (vis(tbuf.as_mut_ptr(), c, flag, *src as libc::c_int)).offset_from(tbuf.as_mut_ptr()) as libc::c_long
                as libc::c_int;
    ...
    if dst.offset(i as isize) > end {
        loop {
            ...
            src = src.offset(1);
            dst = dst.offset(
                (vis(tbuf.as_mut_ptr(), c, flag, *src as libc::c_int)).offset_from(tbuf.as_mut_ptr()) as libc::c_long
                    as isize,
            );
        }
    }
...
pub unsafe extern "C" fn stravis(
    ...
    *outp = realloc(buf as *mut libc::c_void, (len + 1 as libc::c_int) as libc::c_ulong) as *mut libc::c_char;
    if (*outp).is_null() {
        *outp = buf;
